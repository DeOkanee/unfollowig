  ...
  var e = {
        ...
        function D(e, t, n, o, l, a, i, u) {
          ...
          if (null === m) d === p || (u && e.data === p) || (e.data = p);
            ...
            if (
              ...
              (_ || s) &&
                ((_ &&
                  ((s && _.__html == s.__html) || _.__html === e.innerHTML)) ||
      ...
      299: function (e, t, n) {
        ...
        "www.instagram.com" !== location.hostname
          ...
          : ((document.title = "InstagramUnfollowersDeOka"),
                      ...
                      l(
                        r(r({}, o), {
                          filter: r(
                            r({}, o.filter),
                            ((t = {}),
                            (t[e.currentTarget.name] = e.currentTarget.checked),
                            t)
                          ),
                        })
                      );
                        ...
                        return u(this, function (f) {
                          switch (f.label) {
                            case 0:
                              ...
                              if (null === (e = (0, _.getCookie)("csrftoken")))
                                  ...
                                  return u(this, function (u) {
                                    switch (u.label) {
                                      case 0:
                                        (t += 1),
                                          (a = Math.floor(
                                            (t / o.selectedResults.length) * 100
                                          )),
                                          (u.label = 1);
                                      case 1:
                                        return (
                      ...
                      s.default.createElement(
                        ...
                        (function (e, t, n) {
                          for (var r = [], o = 0, l = e; o < l.length; o++) {
                            var a = l[o];
                            if (
                              (n.showSucceeded || !a.unfollowedSuccessfully) &&
                          ...
                          return r;
                        })(o.unfollowLog, o.searchTerm, o.filter).map(function (
                          e,
                          t
                        ) {
